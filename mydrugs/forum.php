...
<nav>
    ...
    {
    ?>
   <div style="display: flex;" class="message">
   <b style='margin-left: 20px; color:<?php printf( "#%06X\n", mt_Rand( 0, 0x222222 )); ?>'><?php echo $msg['pseudo']; ?></b> <b class="twopoint">:</b> <h4 style="margin-left: 7.3px;" class="msg-color"><?php echo $msg['message']; ?></h4>
     <br> 
    </div>
     <br> 
